    ...
    if($this->query->online == "true")
    {
      ...
      switch($this->_type)
      {
        ...
        case 2:
          ...
          $img->text('Online: '.$this->query->players->online, 58, 40, function($font) {
            $font->file($this->banner_font);
            $font->size(12);
            $font->color('#fff');
            $font->align('left');
          ...
          break;
        case 3:
          $img->text(strtoupper($this->_address), 58, 17, function($font) {
            $font->file($this->banner_font);
            $font->size(14);
            $font->color($this->_color);
            $font->align('left');
          ...
          $img->text('Version: '.$this->query->version, 58, 32, function($font) {
            $font->file($this->banner_font);
            $font->size(12);
            $font->color('#fff');
            $font->align('left');
